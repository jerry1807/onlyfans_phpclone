		...
		@endif
        	...
        	<div class="box">
                <div class="box-header">
                  <h3 class="box-title">{{ trans('admin.email_settings') }}</h3>
                </div><!-- /.box-header -->

                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/settings/email') }}" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <select name="MAIL_MAILER" id="emailDriver" class="form-control custom-select">
                            ...
                            <option @if (env('MAIL_MAILER') == 'postmark') selected @endif value="postmark">Postmark</option>
                          </select>
                       ...
                       <!-- Start Box Body -->
                        ...
                        <!-- Start Box Body -->
                         ...
                         <!-- Start Box Body -->
                          <div class="box-body">
                            <div class="form-group">
                              <label class="col-sm-2 control-label">{{trans('admin.default_timezone')}}</label>
                              <div class="col-sm-10">
                                <select name="TIMEZONE" class="form-control custom-select select2">
